...
(function ($, Drupal) {
  ...
  var rangeTemperature = document.querySelector('.range-temperature');

  if (rangeTemperature) {
    var output = document.querySelector('#userTemperature');
    var rangeTemperatureValue = rangeTemperature.value;
  ...
  var rangePain = document.querySelector('.range-pain');

  if (rangePain) {
    var _output = document.querySelector('#userTemperature');

    var rangePainValue = rangePain.value;
    rangePain.addEventListener('input', function () {
      rangePainValue = rangePain.value;

      if (rangePainValue >= 5) {
        _output.classList.add('is-red');
      } else {
        _output.classList.remove('is-red');
      }
    });
  }

  var lastStep = document.querySelector('.progress-step[title="Complete"]');

  if (lastStep) {
    lastStep.remove();
  }

  var radioWrapper = document.querySelector('.form-radios');

  if (radioWrapper) {
    var radioItems = radioWrapper.querySelectorAll('.webform-options-display-buttons-wrapper');
    radioItems.forEach(function (item) {
      item.addEventListener('click', function () {
        var isActive = radioWrapper.querySelector('.webform-options-display-buttons-wrapper.is-active');
...
/******/ 	__webpack_require__.O(undefined, ["css/ea.style"], () => (__webpack_require__("./src/js/ea.script.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/ea.style"], () => (__webpack_require__("./src/scss/ea.style.scss")))
